...
à huit entrées (Tableau de bord, Calendrier, Demandes, Réservations, Tarifs,
Maison, Synchronisations, Activité), écran d'accueil = **Tableau de bord**.
Détail complet dans `04-Dashboard.md`.

...
à onze entrées (Tableau de bord, Calendrier, Demandes, Réservations, Tarifs,
Maison, Équipements, FAQ, Photos, Synchronisations, Activité), écran d’accueil
= **Tableau de bord**. Détail complet dans `04-Dashboard.md`.
